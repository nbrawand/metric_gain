      ...
      <main className="max-w-3xl mx-auto px-4 py-8 sm:px-6 lg:px-8 space-y-8">
        ...
        <section className="bg-gray-800 rounded-lg p-6">
          ...
          <p className="text-gray-300 leading-relaxed">
            In Metric Gain, progressive overload is implemented through mesocycles — structured training blocks that systematically increase demands week over week.
          </p>
        </section>
        ...
        <section className="bg-gray-800 rounded-lg p-6">
          ...
          <p className="text-gray-300 leading-relaxed mb-3">
            Intensity also progresses across the mesocycle through RIR (Reps In Reserve). Week 1 starts at 3 RIR — a comfortable effort level that lets you focus on form and build volume. Each week the RIR decreases, and by the final training week before the deload you're pushing to 0 RIR (failure). This gradual ramp in intensity ensures you accumulate enough stimulus to grow while managing fatigue.
          </p>
          <p className="text-gray-300 leading-relaxed mb-3">
        ...
        <section className="bg-gray-800 rounded-lg p-6">
          ...
          <p className="text-gray-300 leading-relaxed mb-3">
            RIR stands for Reps In Reserve — the number of additional reps you could have performed before reaching failure. It's a way to gauge how hard a set was without actually training to failure every time.
          </p>
          <div className="bg-gray-700 rounded-lg p-4 mb-3">
            <p className="text-white font-medium mb-2">Example</p>
            <p className="text-gray-300 text-sm leading-relaxed">
              You're doing a set of bench press at 135 lbs. You complete 10 reps and stop, but you're pretty sure you could have done 2 more before failing. That set was performed at <span className="text-teal-400 font-medium">2 RIR</span>.
            </p>
          </div>
          <div className="space-y-2 text-sm text-gray-300">
            <p><span className="text-teal-400 font-medium">3 RIR</span> — You had 3 reps left in the tank. The set felt moderate.</p>
            <p><span className="text-teal-400 font-medium">2 RIR</span> — You had 2 reps left. Challenging but controlled.</p>
            <p><span className="text-teal-400 font-medium">1 RIR</span> — You had 1 rep left. Very hard, near your limit.</p>
            <p><span className="text-teal-400 font-medium">0 RIR</span> — You couldn't have done another rep. This is failure.</p>
          </div>
          <p className="text-gray-300 leading-relaxed mt-3">
            Metric Gain uses RIR to manage training intensity across a mesocycle. Early weeks start at a higher RIR (easier effort) so you can build volume, and the RIR decreases each week, pushing you closer to your limits as the block progresses. The deload week uses a very high RIR (8) to allow full recovery.
          </p>
        </section>
